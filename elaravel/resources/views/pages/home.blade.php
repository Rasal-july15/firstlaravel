            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                        <img src="{{URL::to($product->product_image)}}" height="260" alt="" />
                        <h2>TK. {{ $product->product_price }}</h2>
                        <p>{{ $product->product_name }}</p>
                        <a href="{{ URL::to('/product-detail',[$product->product_id]) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div>
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <img src="{{URL::to($product->product_image)}}" height="60" alt="" />
                            <h2>TK. {{ $product->product_price }}</h2>
                            <h4><a href="{{ URL::to('/detail-product',[$product->product_id]) }}">{{ $product->product_name }}</a></h4>
                            <a href="{{ URL::to('/detail-product',[$product->product_id]) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        </div>
                    </div>
                </div>
                <div class="choose">
