...
<head>
    ...
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>@yield('backend_title') - Metro Admin Template</title>
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li>
                        <a class="submenu" href="{{ URL::to('/manage-order') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Order </span></a>
                    </li>
                    ...
                    <li>
                        <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Social Icons </span></a>
                        <ul>
                            <li><a class="submenu" href="{{ URL::to('/all-icon') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Icons </span></a></li>
                            <li><a class="submenu" href="{{ URL::to('/add-icon') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Icon </span></a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a class="submenu" href="{{ URL::to('/all-member') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Members </span></a></li>
                            <li><a class="submenu" href="{{ URL::to('/add-member') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Member </span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
