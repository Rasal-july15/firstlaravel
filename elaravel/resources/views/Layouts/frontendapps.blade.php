...
<head>
    ...
    <title>@yield('frontend_title') | E-Shopper</title>
                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            @if($customer_id !=NULL && $shipping_id==NULL)
                                <li><a href="{{ URL::to('/checkout-page') }}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                            @elseif($customer_id !=NULL && $shipping_id!=NULL)
                                <li><a href="{{ URL::to('/customer-payment') }}"><i class="fa fa-crosshairs"></i> Payment Checkout</a></li>
                            @else
                                <li><a href="{{ URL::to('/customer-login') }}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                            @endif
                            <li><a href="{{ URL::to('/cart-page') }}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                            @if($customer_id !=NULL)
                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    ...
                                    @if($customer_id !=NULL && $shipping_id==NULL)
                                        <li><a href="{{ URL::to('/checkout-page') }}">Checkout</a></li>
                                    @elseif($customer_id !=NULL && $shipping_id!=NULL)
                                        <li><a href="{{ URL::to('/customer-payment') }}">Payment Checkout</a></li>
                                    @else
                                        <li><a href="{{ URL::to('/customer-login') }}">Checkout</a></li>
                                    @endif
                                    <li><a href="{{ URL::to('/cart-page') }}">Cart</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="{{ URL::to('/category-wise-product',[$category->category_id]) }}">{{ $category->category_name }}</a></h4>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="{{ URL::to('/brand-wise-product',[$brand->brand_id]) }}"> <span class="pull-right">(50)</span>{{ $brand->brand_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div><!--/brands_products-->
